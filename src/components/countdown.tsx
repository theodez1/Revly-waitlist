...
interface CountdownProps {
	...
	className?: string;
	label?: string; // Optional label text, defaults to FR
}
...
export default function Countdown({
	period,
	className = "",
	label = "TEMPS RESTANT AVANT LE LANCEMENT",
}: CountdownProps) {
	...
	const ariaLabel = useMemo(
		() =>
			`Compte à rebours : ${timeLeft.days} jours, ${timeLeft.hours} heures, ${timeLeft.minutes} minutes et ${timeLeft.seconds} secondes restantes`,
		[timeLeft],
	);
